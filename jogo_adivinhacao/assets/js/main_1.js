...
function verificaNumero(numero) {
  ...
  {    
    ...
    {
      mensagemDica2 = `Porém, você está muito 'frio/longe' do número!`;
    }
    if((numero-numeroAleatorio) > 20 && (numero-numeroAleatorio) < 30)
    {
      mensagemDica2 = `Porém, você está 'próximo/esquentando' do número!`;
    }
    if((numero-numeroAleatorio) > 10 && (numero-numeroAleatorio) < 20)
    {
      mensagemDica2 = `Porém, você está muito 'próximo/quente' do número!`;
    }
    if((numero-numeroAleatorio) > 5 && (numero-numeroAleatorio) < 10)
    {
      mensagemDica2 = `Porém, você está muito 'quase acertando/pegando fogo' do número!`;
    }
  }
