...
{
  removeFormulario();
  mensagemDica1 = `<center><h2 class='ganhou'>Parabéns! Você acertou!</h2></center>`;
  mensagemDica2 = `A palavra era <b>${palavraSecreta}</b>!`;
  setMensagem(mensagemDica1, mensagemDica2, true);
...
function perdeu()
{
  ...
  mensagemDica2 = `A palavra era <b>'${palavraSecreta}'</b>`;
  setMensagem(mensagemDica1, mensagemDica2, false);
  setAviso(mensagemFinal, true);
  return;
}
...
function setMensagem (msg1, msg2, isValid) 
{
